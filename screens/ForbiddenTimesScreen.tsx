    ...
    return [
      {
        ...
        description:
          "The period from when the sun begins to rise until it has risen to the height of a spear (approximately 15-20 minutes after sunrise).",
        icon: "sunrise",
        iconType: "feather",
      },
      {
        ...
        description:
          "When the sun is at its highest point in the sky. This is a brief period just before the time of Dhuhr begins.",
        icon: "sunny-outline",
        iconType: "ionicons",
      },
      {
        ...
        description:
          "When the sun starts to set until it has completely disappeared. Note: The obligatory Maghrib prayer is excluded from this prohibition once the sun has set.",
      ...
      <View className="flex-1 bg-emerald-darkest">
          ...
          <View className="flex-row items-center flex-1">
            ...
            >
              <Ionicons
                name="arrow-back"
                size={24}
                color={colors["emerald-sage"]}
              />
            </TouchableOpacity>
            <Text
              className="text-emerald-sage text-lg font-bold flex-1"
        ...
        <View className="flex-1 items-center justify-center px-6">
          ...
          <Text className="text-white/40 text-center text-sm leading-5">
            We couldn't load your prayer and sun timings. Please check your
            internet connection or try refreshing the dashboard.
          </Text>
        </View>
      </View>
    );
      ...
      >
        ...
        >
          <View className="p-6 border border-white/5 items-center">
            ...
            {/* Quote Text */}
            <Text
              className="text-white/80 text-[15px] leading-relaxed text-center italic mb-6"
              style={{ fontFamily: "serif" }}
            >
              "And Uqbah ibn Aamir reported: Allah’s Messenger (ﷺ) forbade us
              from praying in three periods: when the sun is rising until it has
              fully risen, when the sun is at its zenith until it has passed the
              meridian, and when the sun is about to set until it has fully
              set."
            </Text>
